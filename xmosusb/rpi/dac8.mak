...
#	./xmosusb --bin2hex ../dac8/DAC8PRO32.bin
	g++ -o dac8pro32      ../src/xmosusb.cpp -I../src -I. -I../dac8 -L. -DDAC8PRO32 -DDSP_CMD=0 -DBIN2HEX_CMD=0 `pkg-config --libs --cflags libusb-1.0`
#	./xmosusb --bin2hex ../dac8/DAC8PRODSPEVAL.bin
	...
	g++ -o dacfabrice     ../src/xmosusb.cpp -I../src -I. -I../dac8 -L. -DDACFABRICE     -DBIN2HEX_CMD=0 `pkg-config --libs --cflags libusb-1.0`
	...
	@cp dacfabrice      ../dac8/utilities/rpi
